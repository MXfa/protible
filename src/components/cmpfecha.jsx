...
const Cmpfecha = ({dia, mes, year, setDia, setMes, setYear, error}) => {
  ...
  return (
    <Box m="20px">
            ...
            <FormControl variant="filled" sx={{ m: 0.2, minWidth: 60 }} error={error}>
            ...
            <FormControl variant="filled" sx={{ m: 0.2, minWidth: 90 }} error={error}>
            ...
            <FormControl variant="filled" sx={{ m: 0.2, minWidth: 80 }} error={error}>
